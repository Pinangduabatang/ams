...
<!--   //connect to database-->
    ...
    %>
        ...
        <a href="stuProfile.jsp" class="w3-bar-item w3-button w3-padding-large w3-theme-d4"><i class="fa fa-home w3-margin-right"></i></a>
    ...
    <button class="w3-button w3-padding-large" >Result</button>
    <div class="w3-dropdown-content w3-card-4 w3-bar-block" style="width:300px">
      <a href="viewgrade.jsp" class="w3-bar-item w3-button">View grade</a>
   ...
   <%}%>
     <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
        ...
        <hr class="w3-clear">
        <form  name="myform" id="myform" method='post' action="../EditAdmin">
        ...
        <table align="center">
            <tr><td colspan="3" align="center">
                <%
                    ...
                    //ResultSet rr= st.executeQuery("select * from detail where email='"+email+"'"); //diffrent database
                %> 
