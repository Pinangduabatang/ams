...
<!--  close header-->
  <%}%>
     <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
        <h4 align="center">Edit Subject</h4>
        <hr class="w3-clear">
        <form  name="myform" id="myform" method='post' action="../EditSubject">
        ...
        <table align="center"  >
            ...
            <tr>
                <td colspan="3" align="center">
                             ...
                             rs= st.executeQuery("select * from subject where name='"+name+"'");
                             if(rs.next()){
                              ...
                              String type1=rs.getString("type");
                                    ...
                                    <tr><td>Subject Name</td><td>:</td><td><input type="text" value="<%= name %>" name="name"></td></tr>
                                    <tr><td>Subject Code</td><td>:</td><td><input type="text" value="<%= code %>" name="code"></td></tr>
                                    <tr><td>Subject Faculty</td><td>:</td><td><input type="text" value="<%= faculty %>" name="faculty"></td></tr>
                                    <tr><td>Subject Type</td><td>:</td><td><input type="text" value="<%= type1 %>" name="type"></td></tr>
...
//You should create the validator only after the definition of the HTML form
    ...
    frmvalidator.EnableOnPageErrorDisplaySingleBox();
     ...
     frmvalidator.addValidation("type1","req");
