                ...
                <td colspan="3" align="center">
                    ...
                    <%
                      if (request.getParameter("submit") != null) {
                        ...
                        rs= st.executeQuery("select * from subject where "+ search +"='"+keyword+"'");
                      ...
                      if(rs.next()){
                             ...
                             String type = rs.getString("type");
                                    ...
                                    <tr><td>Subject Name</td><td>:</td><td><%= name %></td></tr>
                                    <tr><td>Subject Code</td><td>:</td><td><%= code %></td></tr>
                                    <tr><td>Subject Faculty</td><td>:</td><td><%= faculty %></td></tr>
                                    <tr><td>Subject Type</td><td>:</td><td><%= type %></td></tr>
                                            
                                    <tr><td colspan="3"><center><a href=<%= "\"editsubject.jsp?name=" + name + "\"" %>><input type="button" value="Edit" ></a></center></td></tr>
                                     </table></td></tr>
                     ...
                     rs= st.executeQuery("select * from subject ");%>
                                     ...
                                     <table align="center" border="1"  class="table table-hover table-condensed ">
                                         <tr><th colspan="5" align="center">List of Faculty</th></tr>
