            ...
            <tr>
                <td colspan="3" align="center">
                          ...
                          <tr><td colspan="5" ><center>Name List</center></td></tr>
                                    <tr><th>Bil</th><th>Name</th><th>Email</th><th>Phone Number</th><th>IC Number</th><th>Grade</th><th>Edit</th></tr>
                            <% 
                                int bil=0;
                                while(rx.next()){
                              ...
                              while(rs.next()){
                                  ...
                                  bil++;
                                                    %>
                                    <tr><td><%= bil %></td><td><%=name2%></td><td><%=email2%></td><td><%=phonenumber2%></td><td><%=ic2%></td>
                                        <%
                                        ResultSet rp = st2.executeQuery("select * from grade where subjectcode='"+code+"' and section='"+section+"' and studentid='"+studentid1+"'")  ;
                                        if(rp.next()){
                                        String grade=rp.getString("grade");
                                        %>
                                        <td><%= grade %></td><td><center><a href=<%= "\"editgrade.jsp?subjectcode=" + code + "&section="+section+"&studentid="+studentid1+"&grade="+grade+"&studentname="+name2+"\"" %>><input type="button" value="Edit Grade" ></a></center></td>  
