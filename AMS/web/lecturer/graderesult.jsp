                    ...
                    <%                 
                     ...
                     ResultSet rr= st.executeQuery("select * from teaching where lecturerid='"+lecturerid+"'");%>
                             ...
                             int section = rr.getInt("section");
                                    ...
                                    <tr><td><%= subject %></td><td><%= section %></td><td colspan="3"><center><a href=<%= "\"gradesubject.jsp?subject=" + subject + "&section="+section+"\"" %>><input type="button" value="Grade" ></a></center></td></tr>
