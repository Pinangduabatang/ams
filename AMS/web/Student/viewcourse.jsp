<%-- 
    Document   : viewcourse
    Created on : Dec 16, 2017, 10:05:36 AM
    Author     : User
--%>
...
<!--  close header-->
	...
	<TABLE id="dataTable" width="600px" border="1">
            ...
            <%  String studentid=request.getParameter("studentid");
                rs= st.executeQuery("select * from studying where studentid='" + userid +"'");%>
                            
                        <table align="center" border="1"  class="table table-hover table-condensed ">
                            <tr><th colspan="7" align="center">My Courses</th></tr>
                            <tr><th>Subject Code</th><th>Subject Name</th><th>Section</th>
                        ...
                        %>
                             <tr><td><%= subject %></td><td><%= coursename %></td><td><%= section %></td>
                        <%}%>
